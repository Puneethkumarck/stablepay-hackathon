...
public class WalletEntity {
    ...
    @Column(name = "key_share_dek")
    private byte[] keyShareDek;

    @Column(name = "key_share_iv")
    private byte[] keyShareIv;

    @Column(name = "peer_key_share_iv")
    private byte[] peerKeyShareIv;
